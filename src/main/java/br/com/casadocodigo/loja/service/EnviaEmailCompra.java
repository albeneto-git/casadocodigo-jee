...
public class EnviaEmailCompra implements MessageListener {
	...
	public void onMessage(Message message) {
		try {
			...
			String messageBody = "Sua compra foi realizada com sucesso. Número de pedido: " + compra.getUuid();
			mailSender.send("compra@casadocodigo.com.br", compra.getUsuario().getEmail(), "Nova compra no CDC",
					messageBody);
